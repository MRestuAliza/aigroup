    ...
    <>
      <Card className="p-4 flex flex-col border-border lg:flex-row border gap-3 mb-6">
        ...
        <div className="flex flex-col w-full gap-3 justify-end md:flex-row">
          <Select value={filters.collectionId || "all-collections"} onValueChange={(val) => handleFilterChange("collectionId", val)}>
          ...
          <PromptFormDialog key={selectedPrompt ? selectedPrompt.id : "new"} open={isDialogOpen} onOpenChange={setIsDialogOpen} initialData={selectedPrompt} onSuccess={handleSuccess} />
        </div>
      </Card>
